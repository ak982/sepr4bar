...
public class HitBoundsController {
    ...
    public void addHitableComponent(FailableComponentView component, int x, int y, int width, int height) { 
        ...
        if (component instanceof PumpView) {
            ...
            } else if (component instanceof CondenserView){        //component is one of the condenser parts. check which, and ajust acordingly
                if(height < 100){
                    rectangle = new TheRectangle(component, x, y, width, height-(width/2) + 1);
